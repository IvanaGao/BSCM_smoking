...
saveRDS(plot_data, file = "bayes_result_hs.rds")
...
saveRDS(df_diff_long, file = "posterior_difference_horseshoe.rds")
...
png("traceplot_beta1to4_with_rhat_horseshoe.png", width = 1200, height = 800, res = 150)
